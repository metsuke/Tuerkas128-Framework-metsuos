 ...
 * The sprite rendering routine (`framework\tuerkas128_code_render_sprites.asm`) assumes that the last line of the screen is line 23. This means that sprites can be rendered up to the last line of the screen. This saves 38 t-states for each cell in the sprite. For example, the Perseus sprite is 3x4=12 cells, so 456 t-states are saved. One consequence of this is that the scoreboard cannot be placed at the bottom of the screen.
